...
public class LocationActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (checkPlayServices()) {
            ...
            if (!AppUtils.isLocationEnabled(mContext)) {
                ...
                dialog.setPositiveButton("Open locationMarkerText settings", new DialogInterface.OnClickListener() {
                    @Override
